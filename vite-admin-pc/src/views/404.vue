<!--
 * @Author: xingmiao
 * @Date: 2020-07-20 22:48:21
 * @LastEditors: xingmiao
 * @LastEditTime: 2020-07-23 16:28:32
 * @Description: 
 * @FilePath: /client/src/views/404.vue
  ...
  <div class="bac">
      <div class="notfound">
        ...
        <div class="mj">
            ...
            <div class="body">
            <div class="jacket"><div class="hand"></div></div>
            </div>
            <div class="leg"><div class="foot"></div></div>
            <div class="leg lft"><div class="foot"></div></div>
        </div>
        <div class="error-no">
            <span>4</span>
            <div class="moon"></div>
...
.moon:after {
  ...
  box-shadow: -30px -50px 0 20px, 50px -30px 0 -8px, 50px -90px 0 2px,
    100px -90px 0 0, 100px -40px 0 25px, 150px -15px 0 0, 240px 15px 0 4px,
